...
import CalendarHeader from './ServiceReminderHeader'
import * as ReactDOM from 'react-dom'
import { Breadcrumb } from 'app/components'
import { getAllEvents, updateEvent } from './ServiceReminderService'
    ...
    return (
        <div className="m-sm-30">
            <div className="mb-sm-30">
                <Breadcrumb routeSegments={[{ name: 'Service Reminder' }]} />
            </div>
